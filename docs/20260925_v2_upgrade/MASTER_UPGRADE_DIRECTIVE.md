...
SOURCE PRECEDENCE:
1. newest explicit user direction and its linked appendices
2. this DutyNight 2.0 directive
3. current origin/master executable behavior in prototype/
4. current QA
5. docs/20260925_v2_upgrade/
6. docs/20260925_m1_m9_rework/
7. older README/DESIGN/Act1 handoff history

Current Annie model and movement direction:
  docs/20260925_v2_upgrade/ANNIE_VISUAL_REWORK_SPEC.md

Read this newer user-directed spec before changing Annie. It supersedes any
earlier face, hair, or pose language that conflicts with it.
...
M5 / SKYBRIDGE RETURN:
- mannequin manifestation with the same face, coat, and proportions
