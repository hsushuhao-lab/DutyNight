...
const z=r.loadZone('second_campus_5f');z.setWardGateClosed(false);z.setInnerWardGateClosed(false);for(const door of Object.values(z.accessDoors||{})) if(!door.portal) door.setClosed(false);for(const door of Object.values(z.keyedDoors||{}))door.setClosed(false);
...
assert.equal(firstFloor.accessDoors.SECOND_1F_HILLSIDE.portal,null,'second-campus hillside door is closed and has no outdoor route');
