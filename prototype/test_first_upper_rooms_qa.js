...
for(const id of ['first_campus_3f','first_campus_4f']){
 const z=r.loadZone(id);z.setWardGateClosed?.(false);z.setInnerWardGateClosed?.(false);for(const door of Object.values(z.accessDoors||{}))if(!door.portal)door.setClosed(false);for(const door of Object.values(z.keyedDoors||{}))door.setClosed(false);
...
console.log('FIRST UPPER ROOMS V5.2 PASS: 316 admin retained; 401–409 x4 beds plus entrance storage are accessible after staff entry');
