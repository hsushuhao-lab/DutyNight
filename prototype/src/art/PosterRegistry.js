export const ERA_POSTERS = Object.freeze({
  poster_01_restraint_sop: Object.freeze({
    ...
    category:'AMBIGUOUS',
    displayTexture:'/DutyNight/assets/posters/era/display/poster_01_restraint_sop.webp',
    inspectTexture:'/DutyNight/assets/posters/era/inspect/poster_01_restraint_sop.webp',
    inspectable:true,
  ...
  poster_02_auditory_hallucination_knocking: Object.freeze({
    ...
    shortTitle:'複雜性幻聽與敲牆',
    category:'TRUE_CLUE',
    displayTexture:'/DutyNight/assets/posters/era/display/poster_02_auditory_hallucination_knocking.webp',
    inspectTexture:'/DutyNight/assets/posters/era/inspect/poster_02_auditory_hallucination_knocking.webp',
    inspectable:true,
  ...
  poster_03_doppelganger_delusion: Object.freeze({
    ...
    shortTitle:'替身妄想症',
    category:'FALSE_CLUE',
    displayTexture:'/DutyNight/assets/posters/era/display/poster_03_doppelganger_delusion.webp',
    inspectTexture:'/DutyNight/assets/posters/era/inspect/poster_03_doppelganger_delusion.webp',
    inspectable:true,
  ...
  poster_04_hospital_history_1998: Object.freeze({
    ...
    shortTitle:'院史大事紀',
    category:'TRUE_CLUE',
    displayTexture:'/DutyNight/assets/posters/era/display/poster_04_hospital_history_1998.webp',
    inspectTexture:'/DutyNight/assets/posters/era/inspect/poster_04_hospital_history_1998.webp',
    inspectable:true,
  ...
  poster_05_derealization_dissociation: Object.freeze({
    ...
    category:'AMBIGUOUS',
    displayTexture:'/DutyNight/assets/posters/era/display/poster_05_derealization_dissociation.webp',
    inspectTexture:'/DutyNight/assets/posters/era/inspect/poster_05_derealization_dissociation.webp',
    inspectable:true,
  ...
  poster_06_night_shift_attendance: Object.freeze({
    ...
    category:'TRUE_CLUE',
    displayTexture:'/DutyNight/assets/posters/era/display/poster_06_night_shift_attendance.webp',
    inspectTexture:'/DutyNight/assets/posters/era/inspect/poster_06_night_shift_attendance.webp',
    inspectable:true,
  ...
  poster_07_ect_identity_memory: Object.freeze({
    ...
    category:'AMBIGUOUS',
    displayTexture:'/DutyNight/assets/posters/era/display/poster_07_ect_identity_memory.webp',
    inspectTexture:'/DutyNight/assets/posters/era/inspect/poster_07_ect_identity_memory.webp',
    inspectable:true,
  ...
  poster_08_er_jane_doe_triage: Object.freeze({
    ...
    category:'TRUE_CLUE',
    displayTexture:'/DutyNight/assets/posters/era/display/poster_08_er_jane_doe_triage.webp',
    inspectTexture:'/DutyNight/assets/posters/era/inspect/poster_08_er_jane_doe_triage.webp',
    inspectable:true,
