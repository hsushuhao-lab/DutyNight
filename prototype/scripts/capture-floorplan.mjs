...
const views=[
 ...
 ['second5-staff-glass','second_campus_5f',75,1.7,-.8,0,0],
 ...
 ['4f-station','first_campus_4f',0,1.7,-11.4,Math.PI,0],
 ['second5-station','second_campus_5f',72,1.7,-11.4,Math.PI,0],
