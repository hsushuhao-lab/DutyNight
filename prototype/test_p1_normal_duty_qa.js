...
for(const token of ['P1_4F_REPORT','P1_NORMAL_EVENT_DONE','P1_REST_DONE','P1_ER_ASSESSMENT_DONE','P1_ER_NOTE_DONE','P1_RETURN_4F','ACT1_NORMAL_FLOW']) assert.match(uiSource,new RegExp(token));
